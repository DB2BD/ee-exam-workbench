...
3. **Scan existing specs for relevance**
   ...
   Skip this for `no-spec`. Otherwise list `docs/spectra/specs/*/spec.md`, compare spec IDs to the requirement, read short Purpose snippets for up to 3 candidates, and show related specs only as info.
