...
- 本輪已完成 114 年首批 24 題，加上補完的 107 年電路學第 3 題，共 25 題 canonical 詳解並通過 Sol 複核：電路學 6 題、電子學 4 題、電機機械 5 題、電力系統 5 題、工業配電 5 題。稽核 manifest 統計為 `verified=25`、`not_attempted=229`、`suspected_error=0`、`needs_manual_review=0`；其餘題目仍不宣稱已校驗。
