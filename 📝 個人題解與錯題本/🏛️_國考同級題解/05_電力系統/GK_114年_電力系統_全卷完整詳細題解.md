...
-  = j4.2 	imes 10^{-6}\,	ext{S/km} = 4.2 	imes 10^{-6}ngle 90^\circ\,	ext{S/km}$，長度  = 300\,	ext{km}$。
...
$$=$$
\begin{bmatrix} \mathbf{J}_{11} & \mathbf{J}_{12} \\ \mathbf{J}_{21} & \mathbf{J}_{22} \end{bmatrix}
$$
$$
\begin{bmatrix} \Delta \boldsymbol{\theta} \\ \frac{\Delta |\mathbf{V}|}{|\mathbf{V}|} \end{bmatrix}
$$
