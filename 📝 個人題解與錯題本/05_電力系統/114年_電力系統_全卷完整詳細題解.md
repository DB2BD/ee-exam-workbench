...
3. **Newton-Raphson 一階疊代修正公式**：
   $$\begin{bmatrix} \Delta P_2 \\ \Delta Q_2 \end{bmatrix} = \mathbf{J}$$
$$
...
4. **建構雅可比矩陣（Jacobian Matrix $\mathbf{J}$）**：
   $$\mathbf{J} = \begin{bmatrix} \\ \frac{\partial P_2}{\partial \delta_2} & \frac{\partial P_2}{\partial |V_2|} \\ \frac{\partial Q_2}{\partial \delta_2} & \frac{\partial Q_2}{\partial |V_2|} \end{bmatrix}$$
$$=$$
$$
$$
\begin{bmatrix} 10|V_2|\cos \delta_2 & 10 \\ sin \delta_2 \\ 10|V_2|\sin \delta_2 & -10 \\ cos \delta_2 + 20|V_2| \end{bmatrix}
   在初值點 $(\delta_2=0, |V_2|=1.0)$ 計算：
   $$\mathbf{J}^{(0)} = \begin{bmatrix} 10(1) \\ cos 0 & 10 \\ sin 0 \\ 10(1) \\ sin 0 & -10 \\ cos 0 + 20(1) \end{bmatrix}$$
$$=$$
$$
$$
...
5. **求解修正量並更新**：
   \begin{bmatrix} \Delta \delta_2^{(0)} \\ \Delta|V_2|^{(0)} \end{bmatrix}
$$
$$
$$=$$
$$
...
$$
$$
$$= \begin{bmatrix} -0.15 \text{ rad} \\ 0.0 \text{ pu} \end{bmatrix}$$
