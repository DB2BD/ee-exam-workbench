...
review_action: 補齊導線材質、敷設、環境修正與效率／規範版本；現行表可作交叉檢查，但 8 HP 無精確列值，仍須確認考試年度表。
official_source_url: https://wwwq.moex.gov.tw/exam/wHandExamQandA_File.ashx?c=011&code=111180&q=1&s=0612&t=Q
review_evidence: 經濟部《用戶用電設備裝置規則》馬達滿載電流表 258-3 的現行 220 V 列值為：20 HP=55 A、10 HP=28 A、7.5 HP=21 A；題目為 8 HP，無精確列值，且導線安培容量仍取決於材質、配管載流導線數、修正係數與規範版本，故只能作交叉檢查。 來源：https://law.moea.gov.tw/LawContent.aspx?id=FL011045&kw=E%26M；https://gazette.nat.gov.tw/EG_FileManager/eguploadpub/eg028166/ch04/type3/gov31/num7/images/BB.pdf
---
...
兩台 \(20\,\mathrm{HP}\) 馬達的額定電流均為 \(46.071\,\mathrm{A}\)。連續運轉馬達分路導線的最低熱安培容量通常按 \(1.25I_{\mathrm{FL}}\) 檢核，因此最低值為：

\[
I_{w,20}\ge57.589\,\mathrm{A},
\qquad I_{w,10}\ge28.795\,\mathrm{A},
\qquad I_{w,8}\ge23.036\,\mathrm{A}.
\]

若只依題目給出的 \(1.8I_{\mathrm{FL}}\) 計算保護設備上限，則：

\[
I_{\mathrm{OCP,max},20}=82.928\,\mathrm{A},
\quad I_{\mathrm{OCP,max},10}=41.465\,\mathrm{A},
\quad I_{\mathrm{OCP,max},8}=33.172\,\mathrm{A}.
\]
...
I_{w,\mathrm{main}}\ge1.25I_{20}+I_{20}+I_{10}+I_{8}
 =1.25(46.071)+46.071+23.036+18.429
 =145.123\,\mathrm{A}.
\]
