...
> [!NOTE]
> 第 2 題（`EE-113-02-2`）已依參考書更新主解：採 \(V_T=25\,\mathrm{mV}\)，\(R_{in}=50\,\Omega\)、\(A_v=47.52\,\mathrm{V/V}\)。題圖未標示 \(V_T\)，其他分支請見[題號級 canonical 詳解](canonical/EE-113-02-2.md)。
...
> [!CAUTION] 本節缺少題圖未標示的熱電壓 \(V_T\)，請優先閱讀 [EE-113-02-2 canonical](canonical/EE-113-02-2.md) 的多分支結果。
