...
method: reference-book_common-base_T_model_cross-check_with_official_crop
...
reference_book_evidence: 使用者提供參考書照片以 BJT T 模型、V_T=25 mV、r_e=50 Ω 為解題慣例，得到 R_in=50 Ω、A_v=47.52 V/V。此為 reference_book evidence，not official，不是官方題面新增資料。
reference_book_convention: 參考書採 V_T=25 mV；官方題圖未標示 V_T，故 25.85／26 mV 僅列為參數敏感度對照。
---
