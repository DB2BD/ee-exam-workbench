...
review_evidence: 官方裁切圖只提供 MOSFET 差動／回授拓撲，並以文字要求考慮所有 MOSFET 的 r_o；圖中未提供 V_A、R_1、R_2、各管 g_m、r_o、尾電流源阻抗或輸出端口數值；canonical 已保留參數化 A_f=A/(1+Aβ) 及測試源阻抗定義。M_2 閘極不取電流，故輸出端所見分壓器負載為 R_1+R_2，而非 R_1∥R_2。
---
