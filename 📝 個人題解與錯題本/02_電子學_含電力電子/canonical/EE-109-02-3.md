...
method: reference-book_flyback_DCM_boundary_cross-check_with_official_crop
...
reference_book_evidence: 使用者提供參考書照片採磁化電流由零開始的 DCM／臨界導通邊界，得到 I_p(max)=60 A、I_p(avg)=22.5 A（導通區間平均為 30 A）、L_p=274.4 μH、η=93.75%。此為 reference_book evidence，not official，不是官方題面新增資料。
reference_book_convention: 參考書將 I_p(avg) 定義為整個切換週期平均開關電流，並以 DCM 三角波回算；若採 CCM，需另給谷值電流。
---
