...
> **版本**：`2.0.0`
> **最後更新**：2026-08-24
> **核心定位**：極致純前端、零後端依賴、100% 離線可用之「電機工程技師（104~114年 318題）與公務高考三級（110~114年 101道申論大題；23份考選部官方試卷，2個未納入該類科的工程數學欄位）全真雙欄刷題與知識庫儀表板」＋「🇦🇺 澳洲重電工程師求職戰情室」。
...
| **公務高考三級** | `GK` | 考選部公務人員高等考試三級（電力/電子工程），110~114 年目前納入 23 份官方試卷、101 道申論大題；缺少的欄位會明確標記，不以合成檔補足。 |
