...
> [!WARNING]
> 第 2 題（`EE-106-02-2`）官方裁切圖只有 MOSFET 回授拓撲，未提供 R1、R2、gm、ro 與尾電流源阻抗。請以[題號級 canonical 詳解](canonical/EE-106-02-2.md)的參數化結果為準。
...
> [!CAUTION] 本節官方裁切圖未提供 R1、R2、gm、ro 與尾電流源阻抗，請優先閱讀 [EE-106-02-2 canonical](canonical/EE-106-02-2.md) 的參數化結果。
...
> [!WARNING]
> 官方裁切圖未提供 $R_1,R_2$、各 MOSFET 的 $g_m,r_o$ 及尾電流源阻抗，故數值答案無法唯一驗證；本題維持 `needs_manual_review`。
